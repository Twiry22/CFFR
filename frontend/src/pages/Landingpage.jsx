  ...
  const products = [
    {
      ...
      description: "Discover the career path that fits who you are. Answer 10 questions and get matched to Kenya's most promising career clusters — with real schools, real data, and a 3-year outlook.",
      color:       "#2C5FC3",
      colorLight:  "#EEF3FC",
      colorMid:    "#D4E1FA",
